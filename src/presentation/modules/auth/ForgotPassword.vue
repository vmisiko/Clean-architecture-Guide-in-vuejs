        ...
        <div>
            <div class="bg-white rounded-md shadow-md px-4 py-2.5 space-y-4">
                ...
                <div class="flex justify-center mt-5">
                    <span class="uppercase">Forgot Password</span>
                </div>
                <Form v-if="!state.successStatus" class="space-y-4" :validation-schema="schema"
                    @submit="authPloc.forgotPassword(state.email)">
                    ...
                    <p> If your email is Registered with Isuzu, you will be sent a reset link to your email inbox</p>
                    ...
                    <div class="pb-7 pt-5">
                        <Btn class="bg-sidebar-text" :loading="state.loadingRequest" text="Submit"></Btn>
                    </div>
                </Form>

                <div v-else class="flex justify-center pb-5">
                    <p> You have been sent a reset link to your email.</p>
                </div>
            ...
            <div class="flex justify-center mt-10 text-sidebar-text">
                ...
                <span @click="$router.push('/auth/login')" class="underline cursor-pointer ml-2"> Click here</span>
            </div>
        </div>
        <div class="mt-3">
        </div>
