    ...
    <div class="grid grid-cols-3 mt-10">
        ...
        <div>
            <div class="bg-white rounded-md shadow-md px-4 py-2.5 space-y-4">
                ...
                <Form class="space-y-4" :validation-schema="schema" @submit="authPloc.resetPassword({
                    password: state.password,
                    token: $route.params.token as string,
                })">
                    <div class="flex justify-center mt-5">
                        <span class="uppercase">Reset Password</span>
                    </div>
                    ...
                    <TextInput v-model="state.password" name="confirm_password" label="password"
                    ...
                    <TextInput name="password" label="password" :type="passwordType2 ? 'text' : 'password'">
                        <template v-slot:trailing-icon>
                            <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_1051_15188)">
                                    <mask id="mask0_1051_15188" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="0"
                    ...
                    <div class="pb-7 pt-5">
                        <Btn :loading="state.loadingRequest" class="bg-sidebar-text" text="Reset Password"></Btn>
                    </div>
                </Form>
...
const schema = object().shape({
    ...
    confirm_password: string().oneOf([yupRef('password')], 'Passwords do not match')
});

// watch(() => state.i, (val) => {
//     if (val) {
//         router.push('/ffs/login');
//     }
// });
</script>
