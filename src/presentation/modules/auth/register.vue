    ...
    <div class="grid grid-cols-3 mt-10">
        ...
        <div>
            <div class="bg-white rounded-md shadow-md px-4 py-2.5 space-y-4">
                ...
                <Form class="space-y-4" :validation-schema="schema" @submit="submitForm">
                    <div class="flex justify-center mt-5">
                        <span class="uppercase">Register User</span>
                    </div>

                    <TextInput name="email" label="Email" v-model="state.email">
                    ...
                    <TextInput v-model="state.firstname" name="firstName" label="First Name"></TextInput>
                    <TextInput v-model="state.lastname" name="lastName" label="Last Name"></TextInput>
                    <TextInput name="password" label="password" v-model="state.password"
                    ...
                    <div class="pb-7 pt-5">
                        <Btn class="bg-sidebar-text" :loading="state.loadingRequest" text="Register"></Btn>
                    </div>
                </Form>
            </div>
            ...
            <div class="flex justify-center mt-10 text-sidebar-text">
                ...
                <span @click="$router.push('/auth/login')" class="underline cursor-pointer ml-2">LOGIN HERE</span>
            </div>
        </div>
        <div class="mt-3">
        </div>
...
const submitForm = () => {
    authPloc.register({ email: state.email, password: state.password, firstname: state.firstname, lastname: state.lastname });
}
